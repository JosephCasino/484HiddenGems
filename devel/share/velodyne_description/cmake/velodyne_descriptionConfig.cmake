...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_description_SOURCE_PREFIX /home/jcasino2/484HiddenGems/src/velodyne_simulator/velodyne_description)
  set(velodyne_description_DEVEL_PREFIX /home/jcasino2/484HiddenGems/devel)
  ...
  set(velodyne_description_INSTALL_PREFIX /home/jcasino2/484HiddenGems/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jcasino2/484HiddenGems/src/velodyne_simulator/velodyne_description/${idir}'.  ${_report}")
    endif()
